...
from SimGAN_arch6 import Generator, Discriminator
...
parser.add_argument("--exp", type=int, default=47, help="number of experiment")
...
real_data = fn.real_loader("C:/유민형/개인 연구/BESimGAN/Dataset/real5",
                            transform=transforms.Compose([
                                    transforms.ToTensor(),
                                    transforms.Normalize((0.5,),(0.5,))]))
...
for epoch in range(opt.n_epochs):
    for i in range(len(synthetic)):
        ...
        g_loss = torch.mean(torch.abs(D_ref_imgs - (ref_imgs - syn_imgs)))
